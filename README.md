...
## Note - file for human-viewing-only
This file is a copy of SKILL.md, which is the ultimate file for utilization. For the time being, we want an easy human-legible 'front page' for github. This file can be removed at a later date.
